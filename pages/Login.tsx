        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative z-20">
            ...
            <div className="w-full max-w-md animate-slide-up">
                ...
                <div className="glass-panel p-8 md:p-10 rounded-2xl shadow-2xl relative">
                    ...
                    {error && (
                        <div className="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20 text-red-200 text-sm flex items-start">
                            <AlertCircle size={16} className="mt-0.5 mr-3 shrink-0" />
                            <span>{error}</span>
                        </div>
                    )}
                    ...
                    <form onSubmit={handleAuth} className="space-y-5">
                        ...
                        <button 
                            type="submit"
                            disabled={loading}
                            className={`w-full py-4 rounded-xl font-bold text-white shadow-lg transition-all transform hover:-translate-y-0.5 hover:shadow-xl flex items-center justify-center space-x-2 ${
                                isClientMode 
